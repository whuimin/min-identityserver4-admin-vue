...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: parameter => {
        ...
        return getApiResourceList(requestParameters)
          .then(result => {
            const data = {
  ...
  methods: {
    ...
    handleEdit (record) {
      ...
      getApiResourceView(requestParameters)
        .then(result => {
          this.visible = true
          this.mdl = result
        })
    ...
    handleDelete (record) {
      const requestParameters = { id: record.id }
      deleteApiResource(requestParameters)
        .then(result => {
          this.$refs.table.refresh()
